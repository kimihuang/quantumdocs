...
2.3 Transaction Tracker 实现非阻塞失效
-----------------------------------------
...
4.3 不能直接操作 TCU Configuration Cache
-----------------------------------------
...
4.5 CMD_PREFETCH_CONFIG/ADDR 不生效
-------------------------------------
...
5.2 StashTranslation 与 MTLB 预取
----------------------------------
...
6.4 启用 Direct Indexing 的 TBU 的一致性
-----------------------------------------
