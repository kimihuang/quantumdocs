...
3.1 BG 模式（4 Banks / 4 Bank Groups）
-----------------------------------------
...
4.2 WCK2CK 同步（WCK2CK Synchronization）
---------------------------------------------
...
5.3 命令总线训练（Command Bus Training）
--------------------------------------------
...
5.7 占空比调节器（DCA - Duty Cycle Adjuster）
------------------------------------------------
...
5.8 占空比监视器（DCM - Duty Cycle Monitor）
------------------------------------------------
...
5.10 WCK-DQ 训练（WCK2DQ Training）
---------------------------------------
...
5.12 Enhanced RDQS Training 模式
------------------------------------
...
9.7 刷新管理命令（Refresh Management - RFM）
-----------------------------------------------
...
10.4 VREF Current Generator (VRCG)
--------------------------------------
...
13.4 Decision Feedback Equalization (DFE)
--------------------------------------------
...
13.7 tWCK2DQ Interval Oscillator
--------------------------------------
